...
//		$login_id = $row['username'];
    echo "<br> Welcome $role : $name </b>
          ...
          if(isset($_POST['submit-traveler'])){
            ...
            $sql= "SELECT * FROM 2023F_sanchem1.hg_users WHERE username = '$login_name' ";
            $result = mysqli_query($con,$sql);
            ...
            if($count>0){
                ...
                echo "<br><br> <a href='staff_dashboard.php'>$role Dashboard</a>";
                die;
            }
        
            elseif($count==0){
                $sql2= "INSERT into 2023F_sanchem1.hg_users(fname,lname,username,email,pword,role) 
                values('$fname','$lname','$login_name','$email','$password','$accounttype')";
