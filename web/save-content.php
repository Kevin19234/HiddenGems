...
//		$login_id = $row['username'];
    echo "<br> Welcome $role : $name </b>
          ...
          <a href='text_editor.php'>Add More Content</a>
          <br> ";
...
$in_sql = "insert into Articles(content,timestamp,keywords,Title,Author) values('$content','NOW()','$keywords', '$title', '$name')";
...
//$count = mysqli_num_rows($result);
    ...
    if($result){
        ...
        echo "Error adding article. Please try again.";
